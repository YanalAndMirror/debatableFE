...
export default function profile() {
  ...
  let roomSlug =
    "should-a-license-be-required-in-order-to-have-a-child-procreate";
    ...
    <>
      ...
      <div class="modal">
        <div class="modal-box">
          <p>
            {users
              .filter((u) => JSON.parse(u.data).clientData.username !== "Guest")
              .map((u) => {
      ...
      <div class="grid grid-cols-4 gap-2 w-screen" style={{ height: "86vh" }}>
        ...
        <div className="">
          <div class="grid grid-rows-10 gap-1 h-full">
            <center className="flex justify-between row-span-1">
              <button
            ...
            <div className="row-span-3">
              ...
              <div class="bg-clip-content p-2 border-2 border-blue-500 border-dashed">
                {(thisHost ||
                  (data.currentUser &&
                    allowed.includes(data.currentUser._id))) &&
                  (!publisher ? (
                    <button
